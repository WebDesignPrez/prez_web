    ...
    <div className='videoloop '>
      ...
      <div ref={boxMarketingRef} className="boxMarketing">
        ...
        <div class="item imgservices">
          <img src="./img/mk-digital-prez-1.png" alt='Social Media Agencia Marketing Ambato - Prez'/>
        </div>
        <div class="item textservices">
        ...
        <div class="item imgservices">
          <img src="./img/mk-digital-prez-4.png" alt='E-mail Marketing Agencia Marketing Ambato - Prez'/>
        </div>
        <div class="item textservices">
        ...
        <div class="item imgservices">
          <img src="./img/mk-digital-prez-2.png" alt='Inbound Marketing Agencia Marketing Ambato - Prez' />
        </div>
        <div class="item textservices">
        ...
        <div class="item imgservices">
          <img src="./img/mk-digital-prez-5.png" alt='Marketing de contenidos Agencia Marketing Ambato - Prez' />
        </div>
        <div class="item textservices">
        ...
        <div class="item imgservices">
          <img src="./img/mk-digital-prez-3.png" alt='Analítica Web Agencia Marketing Ambato - Prez' />
        </div>
        <div class="item textservices">
          <p><span>SEO</span></p>
        ...
        <div class="item imgservices">
          <img src="./img/mk-digital-prez-6.png" alt='SEO Agencia Marketing Ambato - Prez' />
        </div>
