            ...
            <div id="Servicios" className="serviciosRow serviciosclientes">
                <div className="box" onClick={() => { selOpt('md') }}>
                    <div className="imgBox">
                        <img src="./img/herramientas1.png" alt="Marketing Digital Prez Vehicentro" />
                    </div>
                ...
                <div className="box" onClick={() => { selOpt('pm') }}>
                    <div className="imgBox">
                        <img src="./img/herramientas2.png" alt="Paid Media Prez Vehicentro" />
                    </div>
                ...
                <div className="box" onClick={() => { selOpt('gl') }}>
                    <div className="imgBox">
                        <img src="./img/herramientas3.png" alt="Generación de Leads Prez Vehicentro" />
                    </div>
                ...
                <div className="box" onClick={() => { selOpt('dw') }}>
                    <div className="imgBox">
                        <img src="./img/herramientas5.png" alt="Desarrollo Web / e-commerce Prez Vehicentro" />
                    </div>
                ...
                <div className="box" onClick={() => { selOpt('fv') }}>
                    <div className="imgBox">
                        <img src="./img/herramientas4.png" alt="Producción, fotográfica, audio y video Prez Vehicentro" />
                    </div>
