    ...
    return (
        <div>
            ...
            <div class="contenedor-imagenesMD">
                <img src="./img/imagenIzquierda.jpg" alt="Producción fotografia, audio y video atras, Agencia de marketing" class="imagen1" />
